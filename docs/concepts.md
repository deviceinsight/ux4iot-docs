...
![Connection State Logic](images/connection state ux4iot.drawio.png)

The connection state logic of ux4iot works for most use cases. However with the configuration variables for CUSTOM_CONNECTION_STATE_KEY and CONNECTION_STATE_ON_TELEMETRY you have the option of implementing your own connection state logic that your project needs.
