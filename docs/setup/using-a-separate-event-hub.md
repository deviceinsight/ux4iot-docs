...
![Messages transformed by Azure Functions and written to Event Hub](../images/ux4iot-event-hub-scenarios.png)
...
![Custom Protocol Adapter](../images/ux4iot-event-hub-scenarios-4-.png)

## Scenario 3

Data is received not from devices directly but via some other cloud.

![Data forwarded from other cloud](../images/ux4iot-event-hub-scenarios-5-.png)
